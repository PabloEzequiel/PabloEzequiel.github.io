...
{% highlight java %}
package com.probarnocuestanada.pay.drivebuypay;
{% endhighlight  %}
...
defaultConfig {
    applicationId "com.probarnocuestanada.pay.drivebuypay"
    minSdkVersion 14
    targetSdkVersion 23
    versionCode 7
    versionName "1.5"
...
Ok, después de un poco de trabajo, pude renombrar los paquetes, gracias a deseleccionar la opción:
**Compact Empty Middle Packages** que me muestra las carpetas de proyecto de Android separadas.
